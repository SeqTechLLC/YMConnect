...
const INT32 OK = 0x00;
static const std::string YMConnectVersion = "1.0.0";
...
extern "C" {
	...
	namespace YMConnect
	{
		...
		YMCONNECT_API MotomanController* OpenConnection(const std::string& ip, StatusInfo& statusCode, UINT32 receivePacketTimeout_ms = 500, UINT32 sendPacketRetries = 3);
